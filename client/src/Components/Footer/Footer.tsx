                ...
                <div className="container py-4">
                    <div className="row">
                        <div className="col-lg-6">
                            <p className="fst-italic text-muted">"Most rock journalism is people who can't write, interviewing people who can't talk, for people who can't read". -Frank Zappa</p>
                        </div>
                    </div>
                </div>
            </section>
