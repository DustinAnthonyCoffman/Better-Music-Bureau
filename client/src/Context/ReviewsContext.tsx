import {ReviewI, ReviewsI} from '../Interfaces/interfaces'
import {createContext, ReactNode, useReducer, PropsWithChildren, ReducerAction} from 'react'
import { ReviewsContextDispatch, ReviewsContextProviderProps } from '../Interfaces/interfaces';
...
export const ReviewsContext = createContext<ReviewsContextDispatch | null>(null);
